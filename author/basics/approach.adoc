...
Formal editorial guidelines of standards bodies prescribe the contents of standards to a level
...
A formal document model allows checking for consistency of format and content, and expedites
authoring and quality control of standardized documents. Authoring standards through a
more abstract formal model also permits enhanced functionality such as
cross-referencing and link checking; and auto-numbering of sections, figures, tables and formulas.
Outputting a document in different languages and physical formats also becomes straightforward.
...
(using relatively lightweight markup), and the rigour and expressivity of the
latter (it has a well-defined syntax, and was in fact initially developed as a
DocBook abbreviated syntax and document authoring tool).
...
see the link:/author/topics/document-format/[Document format] section of author's documentation.

[NOTE]
====
The Metanorma document model does not impose AsciiDoc constraints,
...
However, beware that Metanorma AsciiDoc features and flavor-specific features cannot be
